...
model = load_model('leaffinal.h5')
 
labels = {0: 'Aam', 1: 'Amrud', 2: 'Annar', 3: 'Arhul', 4:'Chandan', 5: 'Chandni', 6: 'Curry', 7: 'Drumstick', 8: 'Ghrit Kumari', 9: 'Giloy', 10: 'Harive-Dantu', 11: 'Jackfruit', 12:'Jamaica Cherry' , 13:'Jamun' , 14: 'Karanda', 15:'Karanja' , 16:'Malabar spinach' , 17:'Menthee', 18:'Mogra', 19:'Neem',20:'Nimbu', 21:'Oleander', 22:'Paan' , 23:'Parijata', 24: 'Peepal', 25: 'Phagoora', 26: 'Pudina', 27: 'Rasna', 28: 'Rose Apple', 29: 'Sarso', 30: 'Tindora',31: 'Tulsi'}   
...
r={'Menthee':'Fenugreek is taken by mouth for digestive problems such as loss of appetite, upset stomach, constipation, inflammation of the stomach (gastritis). Fenugreek is also used for diabetes, painful menstruation, polycystic ovary syndrome, and obesity'}
...
def run():
    ...
    if img_file is not None:
        ...
        #     st.info('**Benifits : '+ f.get('Chandni')+'**')
            ...
            st.info('**Benifits : '+ r.get('Menthee')+'**')
        elif result in s:
